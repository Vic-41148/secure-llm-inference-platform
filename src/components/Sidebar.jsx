...
const Sidebar = ({ activeView, onNavigate }) => {
  ...
  return (
    ...
    >
      ...
      <div
        className="flex-shrink-0 border-t py-2 px-2 border-[var(--border-primary)]"
      >
        <button
          onClick={() => setCollapsed((c) => !c)}
          className="w-full flex items-center rounded-xl transition-all duration-200 py-1.5 hover:bg-[var(--card-bg-hover)] text-[var(--text-muted)] hover:text-[var(--text-primary)]"
          style={{
            justifyContent: collapsed ? 'center' : 'flex-start',
